      ...
      <header className="border-b border-border/30 bg-card/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bebas glow-primary">Cadastrar Novo Afiliado</h1>
              <p className="text-muted-foreground font-inter">Preencha os dados para cadastrar um novo afiliado</p>
            </div>
          </div>
        </div>
      </header>
