...
export const AffiliateForm = ({ onSuccess }: AffiliateFormProps) => {
  ...
  return (
    <Card className="w-full max-w-2xl bg-card/80 backdrop-blur-sm border-glow">
      <CardHeader>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="nome" className="text-foreground font-inter">
              Nome Completo
            </Label>
            <Input
              id="nome"
          ...
          <div className="space-y-2">
            <Label htmlFor="telefone" className="text-foreground font-inter">
              Telefone / WhatsApp
            </Label>
            <Input
              id="telefone"
          ...
          <div className="space-y-2">
            <Label htmlFor="cidade" className="text-foreground font-inter">
              Cidade / Estado
            </Label>
            <Input
              id="cidade"
          ...
          <div className="space-y-2">
            <Label htmlFor="descricao" className="text-foreground font-inter">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bebas text-xl py-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/50"
          >
